type ThemeFunction = (path: string, defaultValue?: unknown) => unknown;

interface TypographyTheme {
    theme: ThemeFunction;
}

const typographyConfig = ({ theme }: TypographyTheme) => ({
    DEFAULT: {
        css: {
            ...
            fontSize: (theme("fontSize.sm") as [string])[0],
            ...
            '[class~="lead"]': {
                fontSize: (theme("fontSize.base") as [string, Record<string, unknown>])[0],
                ...(theme("fontSize.base") as [string, Record<string, unknown>])[1],
            },
            ...
            h1: {
                ...
                fontWeight: "700",
                fontSize: (theme("fontSize.2xl") as [string, Record<string, unknown>])[0],
                ...(theme("fontSize.2xl") as [string, Record<string, unknown>])[1],
                marginBottom: theme("spacing.2"),
            },
            h2: {
                color: "var(--tw-prose-headings)",
                fontWeight: "600",
                fontSize: (theme("fontSize.lg") as [string, Record<string, unknown>])[0],
                ...(theme("fontSize.lg") as [string, Record<string, unknown>])[1],
                marginTop: theme("spacing.16"),
                marginBottom: theme("spacing.2"),
            },
            h3: {
            ...
            figcaption: {
                ...
                fontSize: (theme("fontSize.xs") as [string, Record<string, unknown>])[0],
                ...(theme("fontSize.xs") as [string, Record<string, unknown>])[1],
                marginTop: theme("spacing.2"),
            },
            ...
            ":is(tbody, tfoot) td:first-child": { paddingLeft: "0" },
            ":is(tbody, tfoot) td:last-child": { paddingRight: "0" },
            ...
            ":is(a, h1, h2, h3, blockquote, thead th) code": { color: "inherit" },
            "h2 code": {
                fontSize: (theme("fontSize.base") as [string])[0],
                fontWeight: "inherit",
            },
            "h3 code": {
                fontSize: (theme("fontSize.sm") as [string])[0],
